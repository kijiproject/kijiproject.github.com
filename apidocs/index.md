...
* [KijiSchema](http://api-docs.kiji.org/kiji-schema/1.0.0-rc4/index.html) (latest) 
...
* [KijiMR](http://api-docs.kiji.org/kiji-mapreduce/1.0.0-rc4/index.html) (latest)
  \[[1.0.0-rc4](http://api-docs.kiji.org/kiji-mapreduce/1.0.0-rc4/index.html)\]

* [KijiMR Library](http://api-docs.kiji.org/kiji-mapreduce-lib/1.0.0-rc4/index.html) (latest)
...
<ul>
  <li><a href="http://api-docs.kiji.org/annotations/1.0.0-rc4/index.html">annotations</a>
...
<ul>
  ...
  <li><a href="http://api-docs.kiji.org/kiji-delegation/1.0.0-rc4/index.html">kiji-delegation</a>
